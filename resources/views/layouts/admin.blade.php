...
<div class="flex min-h-screen">
    ...
    <aside id="wp-sidebar" :class="sidebarOpen ? '' : 'collapsed'">
        ...
        <nav class="flex-1 overflow-y-auto py-2">
            ...
            <a href="{{ route('admin.sidebar-banners.index') }}" class="sidebar-link {{ request()->routeIs('admin.sidebar-banners*') ? 'active' : '' }}">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                <span class="nav-label">بانرات الشريط الجانبي <span class="en-hint">Sidebar Banners</span></span>
            </a>
        ...
        <a href="{{ route('admin.profile.edit') }}" class="sidebar-link {{ request()->routeIs('admin.profile*') ? 'active' : '' }}" style="border-top:1px solid var(--wp-sidebar-border); margin-top:auto;">
            ...
            <span class="nav-label">حسابي <span class="en-hint">My Profile</span></span>
        </a>
