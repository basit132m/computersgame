...
<head>
    ...
    @yield('head')
    @stack('head')
    <style>.en-hint{font-size:10px;color:#9ca3af;font-weight:400;display:block;line-height:1.2;margin-top:1px}</style>
</head>
    ...
    <aside class="bg-white shadow-lg w-64 flex-shrink-0 flex flex-col" :class="sidebarOpen ? 'block' : 'hidden md:block'">
        ...
        <nav class="flex-1 p-3 space-y-1 overflow-y-auto">
            <a href="{{ route('admin.dashboard') }}" class="sidebar-link {{ request()->routeIs('admin.dashboard') ? 'active' : '' }}">
                ...
                <span>لوحة التحكم <span class="en-hint">Dashboard</span></span>
            </a>

            <div class="pt-2">
                <p class="text-xs font-semibold text-gray-400 uppercase px-4 mb-1">المحتوى — Content</p>
                <a href="{{ route('admin.posts.index') }}" class="sidebar-link {{ request()->routeIs('admin.posts*') ? 'active' : '' }}">
                    ...
                    <span>إدارة المقالات <span class="en-hint">Posts</span></span>
                </a>
                <a href="{{ route('admin.categories.index') }}" class="sidebar-link {{ request()->routeIs('admin.categories*') ? 'active' : '' }}">
                    ...
                    <span>إدارة التصنيفات <span class="en-hint">Categories</span></span>
                </a>
                <a href="{{ route('admin.tags.index') }}" class="sidebar-link {{ request()->routeIs('admin.tags*') ? 'active' : '' }}">
                    ...
                    <span>إدارة الوسوم <span class="en-hint">Tags</span></span>
                </a>
                <a href="{{ route('admin.comments.index') }}" class="sidebar-link {{ request()->routeIs('admin.comments*') ? 'active' : '' }}">
                    ...
                    <span>إدارة التعليقات <span class="en-hint">Comments</span></span>
                </a>
                <a href="{{ route('admin.media.index') }}" class="sidebar-link {{ request()->routeIs('admin.media*') ? 'active' : '' }}">
                    ...
                    <span>مكتبة الوسائط <span class="en-hint">Media Library</span></span>
                </a>
            </div>

            <div class="pt-2">
                <p class="text-xs font-semibold text-gray-400 uppercase px-4 mb-1">التحميل — Downloads</p>
                <a href="{{ route('admin.download-links.index') }}?post_id=1" class="sidebar-link {{ request()->routeIs('admin.download-links*') ? 'active' : '' }}">
                    ...
                    <span>روابط التحميل <span class="en-hint">Download Links</span></span>
                </a>
                <a href="{{ route('admin.analytics.index') }}" class="sidebar-link {{ request()->routeIs('admin.analytics*') ? 'active' : '' }}">
                    ...
                    <span>التحليلات <span class="en-hint">Analytics</span></span>
                </a>
            </div>

            @if(auth()->user()->isAdmin())
            <div class="pt-2">
                <p class="text-xs font-semibold text-gray-400 uppercase px-4 mb-1">الإعدادات — Settings</p>
                <a href="{{ route('admin.ad-slots.index') }}" class="sidebar-link {{ request()->routeIs('admin.ad-slots*') ? 'active' : '' }}">
                    ...
                    <span>إدارة الإعلانات <span class="en-hint">Ad Slots</span></span>
                </a>
                <a href="{{ route('admin.seo.index') }}" class="sidebar-link {{ request()->routeIs('admin.seo*') ? 'active' : '' }}">
                    ...
                    <span>إعدادات SEO <span class="en-hint">SEO Settings</span></span>
                </a>
                <a href="{{ route('admin.sitemap.index') }}" class="sidebar-link {{ request()->routeIs('admin.sitemap*') ? 'active' : '' }}">
                    ...
                    <span>خريطة الموقع <span class="en-hint">Sitemap</span></span>
                </a>
                <a href="{{ route('admin.redirects.index') }}" class="sidebar-link {{ request()->routeIs('admin.redirects*') ? 'active' : '' }}">
                    ...
                    <span>إدارة التحويلات <span class="en-hint">Redirects</span></span>
                </a>
                <a href="{{ route('admin.ip-blocks.index') }}" class="sidebar-link {{ request()->routeIs('admin.ip-blocks*') ? 'active' : '' }}">
                    ...
                    <span>حظر عناوين IP <span class="en-hint">IP Blocks</span></span>
                </a>
                <a href="{{ route('admin.users.index') }}" class="sidebar-link {{ request()->routeIs('admin.users*') ? 'active' : '' }}">
                    ...
                    <span>إدارة المستخدمين <span class="en-hint">Users</span></span>
                </a>
                <a href="{{ route('admin.settings.index') }}" class="sidebar-link {{ request()->routeIs('admin.settings*') ? 'active' : '' }}">
                    ...
                    <span>الإعدادات <span class="en-hint">Settings</span></span>
                </a>
            </div>
            @endif
        </nav>
