...
@if(request('platform') || (request('sort') && request('sort') !== 'latest'))
...
<div class="flex gap-5">
    ...
    {{-- Sidebar --}}
    <div class="hidden lg:block w-72 flex-shrink-0" style="position:sticky;bottom:1rem;align-self:flex-start;">
